...
/*   Updated: 2024/05/04 20:07:02 by maroy            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
#define PUT_HEADER(x) std::cout << std::string(40, '*') << std::endl << "TEST : " << typeid(x).name() << std::endl << std::string(40, '*') << std::endl;

template< typename T >
void test_print(T &elem) {
	PRINT(elem)
}
